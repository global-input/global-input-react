...
exports.createInputReceivers = createInputReceivers;
exports.toBeSameInitData = toBeSameInitData;

function createInputReceivers(config = {}) {
  let inputs = null;
  let input = null;
...
function toBeSameInitData(received, expected) {
